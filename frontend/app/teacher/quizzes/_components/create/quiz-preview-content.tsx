    ...
    return (
        <div className="space-y-6">
            <div className="space-y-3">
                ...
                <div className="flex gap-2 flex-wrap">
                    ...
                    {payload.isSingleAttempt && (
                        <Badge variant="outline">{t.teacher.assignments.previewAssignment.isSingleAttempt}</Badge>
                    )}
                </div>
            </div>
                                            ...
                                            {question.choices.map((choice, cIndex) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1">
                                                        <div className={`text-sm flex items-start gap-1 ${choice.isCorrect ? 'font-semibold text-green-700 dark:text-green-300' : 'text-gray-600 dark:text-gray-400'}`}>
            ...
            <div className="text-xs text-muted-foreground text-center">
                <p>
                    {t.teacher.assignments.previewAssignment.summary} {payload.tasks?.length || 0} task,{' '} {payload.tasks?.reduce((sum, task) => sum + (task.questions?.length || 0), 0) || 0}{' '} {t.teacher.assignments.previewAssignment.summaryQuestions}
                </p>
            </div>
        </div>
    )

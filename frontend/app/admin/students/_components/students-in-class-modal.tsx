...
export function StudentsInClassModal({
    ...
    const displayedStudents = useMemo(() => {
        ...
        return [...filteredStudents].sort((leftStudent, rightStudent) => {
            ...
            const leftJoinedAt = new Date(leftStudent.joinedAt || 0).getTime()
            const rightJoinedAt = new Date(rightStudent.joinedAt || 0).getTime()
            ...
            switch (activeSort.value) {
                ...
                case 'date-asc':
                case 'date-desc':
                    comparison = leftJoinedAt - rightJoinedAt
                    break
                default:
                    comparison = 0
            }
